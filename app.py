...
content = {
    ...
    "العربية": {
        ...
        "subtitle": "أول دراسة مبنية على البيانات حول الطلب على التاكسي الجماعي في محور كالة كبرى ← باب البحر",
        ...
        "solutions": [
            ("🕐 تنظيم فترات المغادرة", "مغادرة منظمة كل 12 دقيقة من كالة كبرى خلال ساعات الذروة. يلغي فجوات العرض (الحالة 3)."),
...
# ══════════════════════════════════════════════════════════════
    ...
    zone_options    = {"Kalaa Kebira": "Kalaa_Kebira", "Akouda": "Akouda", "Sousse City": "Sousse_City"}
    timeslot_options = {
